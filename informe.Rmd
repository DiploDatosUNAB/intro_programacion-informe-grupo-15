...
Pensar un indicador de concentración. Cuántos variedades distintas de vinos hay para cada provincia / región y cuál es la participación de la cepa / variedad más reseñada para esa provincia / región. Observar casos de regiones que tienen pocos registros (quizas convenga excluirlos del análisis, en función de n reseñas)
