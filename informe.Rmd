...
Armar un gráfico, luego intentar regresión. 

2- Para cada provincia/region las variedades reseñadas se concentran fuertemente en una variedad particular de vinos.

Pensar un indicador de concentración. Cuántos variedades distintas de vinos hay para cada provincia / rergión y cuàl es la participación de la cepa / variedad más reseñada para esa provincia / región. Observar casos de regiones que tienen pocos registros (quizas convenga excluirlos del análisis, en función de n reseñas)
